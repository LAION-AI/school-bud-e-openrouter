...
export const notebookContent: InternalizationContent = {
  ...
  de: {
    ...
    close: "Schliessen",
    hide: "Ausblenden",
    runAll: "Alle ausfuehren",
    runCell: "Zelle ausfuehren (Strg+Enter)",
    stop: "Stopp",
    restart: "Neu starten",
    ...
    notebooksHint:
      "Jedes Notebook wird einzeln in diesem Browser gespeichert. Leg so viele an, wie du magst - eins pro Thema bewaehrt sich.",
    examples: "Beispiele zum Lernen",
    examplesHint:
      "Wird als deine eigene Kopie geoeffnet - du kannst also alles veraendern, ohne das Original zu verlieren.",
    untitled: "Ohne Titel",
    ...
    exportHint: "Laedt das Notebook herunter, es oeffnet sich in Jupyter oder Colab.",
    codePlaceholder: "Python-Code - Strg+Enter fuehrt die Zelle aus",
    textPlaceholder: "Notizen und Erklaerungen zu diesem Notebook",
    ...
    running: "Laeuft...",
    confirmDeleteNotebook: "Dieses Notebook endgueltig loeschen?",
    hint:
      "Die Zellen teilen sich einen Interpreter - eine Variable aus Zelle 1 ist in Zelle 2 noch da.",
    helpTitle: "Was ist das hier?",
    helpIntro:
      "Ein Platz zum Schreiben und Ausfuehren von Python - der Sprache, mit der Webseiten, Spiele, Datenauswertungen und KI gebaut werden. Du musst nichts installieren: Python laeuft in diesem Browser-Tab.",
    helpRunTitle: "Eine Zelle ausfuehren",
    helpRun:
      "Klick in eine Zelle und druecke Strg+Enter, oder nimm das kleine Dreieck. Was das Programm ausgibt, erscheint direkt unter der Zelle. Die Zellen teilen sich ihre Variablen - was du oben festlegst, ist weiter unten noch bekannt.",
    helpFirstRunTitle: "Der erste Start dauert kurz",
    helpFirstRun:
      "Python selbst muss erst geladen werden, etwa 10 MB. Das dauert einmalig ein paar Sekunden; danach liegt es im Browser-Speicher und startet sofort. Groessere Werkzeuge wie numpy oder matplotlib kommen erst dazu, wenn ein Programm sie wirklich benutzt.",
    helpNotebooksTitle: "Mehrere Notebooks",
    helpNotebooks:
      "Unter \"Notebooks\" legst du beliebig viele an und wechselst zwischen ihnen; den Namen aenderst du oben im Feld. Direkt daneben stehen fertige Beispiele, vom ersten print bis zum kleinen Spiel - jedes oeffnet sich als deine eigene Kopie.",
    helpPackagesTitle: "Pakete installieren",
    helpPackages:
      "Genau wie in Google Colab: schreib !pip install <name> in eine Zelle. Das klappt fuer Pakete aus reinem Python. numpy, pandas und matplotlib sind schon dabei und brauchen kein pip.",
    helpPrivacy:
      "Alles bleibt bei dir: der Code laeuft in diesem Browser und wird nie an einen Server geschickt. Notebooks werden lokal gespeichert und wandern bei der Postfach-Sicherung mit.",
  },
};
